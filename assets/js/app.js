"use strict";
import { numToKilo } from "./module.js";
...
window.updateProfile = function (profileUrl) {
  ...
  $repoPanel.innerHTML = `
    ...
    <div class="card-body">
        ...
        <div class="skeleton title-skeleton text-2"></div>
    </div>
  ...
  twitter_username
    ...
    : ""
        ...
        <ul class="profile-stats">
            ...
            <li class="stats-item"><span class="body">${numToKilo(followers)}</span>Followers</li>

            <li class="stats-item"><span class="body">${numToKilo(following)}</span>Following</li>
        </ul>

        <div class="footer">
            <p class="copyright">&copy; 2024 devbello_</p>
        </div>
  ...
  language
    ? `<div class="card-footer">
                ...
                <div class="meta-item">
                  ...
                  <span class="span">${numToKilo(starsCount)}</span>
                </div>
                <div class="meta-item">
                  <span class="material-symbols-rounded">family_history</span>
                  <span class="span">${numToKilo(forks_count)}</span>
                </div>
              </div>`
    : ""
}
...
`;
    ...
    if (data.length) {
      ...
      <div class="error-content">
              <p class="title-1">Oops! :(</p>
              <p class="text">You don't have any follower yet.</p>
            </div>
